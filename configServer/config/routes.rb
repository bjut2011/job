Authpuppy::Application.routes.draw do
  ...
  get "getapregisted" => "access_nodes#getregisted"
  ...
  post "api10/fingerinfo" => "wifidog#fingerprint"
  get "api10/fingerinfo" => "wifidog#fingerprint"
  get "api10/tag" => "user#tag"
  post "api10/tag" => "user#tag"
  post "api10/weixintoap" => "access_nodes#weixintoap"
  get "api10/weixintoap" => "access_nodes#weixintoap"
  ...
  get "auto/portal" => "admins#auto_login"
  ...
  post "api10/update_auth_type" => "guest#update_auth_type"
  post "api10/update_portal_url" => "guest#update_portal_url"
  post "api10/update_welcome_url" => "guest#update_welcome_url"
  ...
  get "defriending" => "user#defriending"
  get "welcome/ioswificheck.php" => "user#ioswificheck"
  #get "home/meinuo"
  get "api10/customerTraffic" => "admins#customerTraffic"
end
