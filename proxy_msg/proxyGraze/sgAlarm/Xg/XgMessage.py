...
def BuildMsg(content):
    ...
    #msg.custom = {'aaa':'111', 'bbb':'222'}
    msg.custom = {'Type':'InGeofence', 'Data':{'Msg':'out','Type':'1','BLat':'41.1','BLon':'113','Address':'bj','DateTime':'2017-7-22','DeviceID':'576200c2421aa937a2000000'}}
    # 使用多包名推送模式，详细说明参见文档和wiki，如果您不清楚该字段含义，则无需设置
    #msg.multiPkg = 1
...
def DemoPushAccount(x, msg):
    ret = x.PushSingleAccount(0, '57579810421aa9f0b4000001', msg, xinge.XingeApp.ENV_DEV)
    print ret
...
if '__main__' == __name__:
    ...
    x = xinge.XingeApp(2100212987, 'b888f49662e8ce6dc92d8bb481a65586')
