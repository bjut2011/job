class SensorsController < ApplicationController
  ...
  def getSensorsByID
    ...
    @sensor=Sensor.where(:device_id => @device.id).sort(:order)
  ...
  def querySensorDataDetail
    ...
    @sensors=Sensorlog.where(:sensor_id => sensorId,:update_time.gt => tm,:update_time.lt => tm_e).paginate(page:params[:page],per_page:50)
