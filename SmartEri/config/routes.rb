Rails.application.routes.draw do
  ...
  resources :contacts
  resources :sensors
  post 'devices/ping' =>"devices#ping"
  get 'devices/ping' =>"devices#ping"
  get 'alarmsms' =>"devices#alarmsms"
  get 'start' =>"users#home"
  get 'lists' =>"devices#lists"
  get 'search' =>"devices#search"
  get 'chart' =>"devices#chart"
  get 'flowinfo' =>"devices#flowinfo"
  get 'panel' =>"devices#panel"
  get 'alarms/toAddAlarms' =>"alarms#toAddAlarms"
  get 'alarmlists' =>"alarms#alarmlogs"
  ...
  get 'statistics' =>"devices#statistics"
  get 'province' =>"devices#province"
  get 'point' =>"devices#point"
  get 'city' =>"devices#city"
  get 'trash' =>"devices#trash"
  get 'map' =>"devices#map"
  ...
  post 'getSensor' =>"sensors#getSensor"
  resources :devices
  resources :projects
